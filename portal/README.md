...
- **Investor side** — each investor signs in and sees only their own room: position stats (principal / rate / term / docs signed), four in-portal e-sign documents (Non-Binding Letter of Intent, Promissory Note — borrower: 3331 Trumbull LLC, Personal Guarantee Acknowledgment — guarantor: Lukas Bondy of Bondy Construction & Design, and Accredited Investor Verification with an accredited / non-accredited selection), the shared project document library, and a private 1:1 message thread with Kevin.
